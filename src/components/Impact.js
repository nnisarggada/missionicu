...
const Impact = () => {
  ...
  return (
    <div>
      <div
        id="impact"
        className="flex flex-col justify-center gap-6 pt-28 md:pt-28 md:gap-10 lg:flex-row"
      >
        <div className="flex flex-col gap-4 p-4 md:p-6 lg:w-1/2">
          ...
          <p className="text-xl font-medium md:text-2xl">
            In any small town, the district hospitals bear 80% of the load
            during a pandemic like situation. Bolstering the capacity and
            infrastructure in these hospitals will help maximize the number of
            treated COVID instances.
          </p>
        ...
        <div className="bg-beds bg-no-repeat bg-cover h-[800px] p-10 flex flex-col justify-between items-center md:flex-row md:justify-evenly md:h-[500px] lg:w-1/2">
